...
public class OpenVRStereoRenderer extends VRRenderer
{
    ...
    public void createRenderTexture(int lwidth, int lheight)
    {
        ...
        long eglImage = EGL15.eglCreateImage(EGL10.eglGetCurrentDisplay(), EGL15.eglGetCurrentContext(), EGL15.EGL_GL_TEXTURE_2D, VLoader.convertImgToEGLBuffer(i), null);
        int nativeImage = VLoader.getNativeImage(eglImage, lwidth, lheight);
        this.openvr.texType0.handle = Pointer.createConstant(nativeImage);
        ...
        GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL11.GL_RGBA8, lwidth, lheight, 0, GL11.GL_RGBA, GL11.GL_INT, (ByteBuffer)null);
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, i);
        long eglImage2 = EGL15.eglCreateImage(EGL10.eglGetCurrentDisplay(), EGL15.eglGetCurrentContext(), EGL15.EGL_GL_TEXTURE_2D, VLoader.convertImgToEGLBuffer(i), null);
        int nativeImage2 = VLoader.getNativeImage(eglImage2, lwidth, lheight);
        this.openvr.texType1.handle = Pointer.createConstant(nativeImage2);
